<fieldset>
    ...
    <?php if($propiedad->imagen){ ?>
        <img src="/imagenes/<?php echo $propiedad->imagen ?>" class="img-small" alt="imagen de la propiedad">
    <?php } ?>
...
<fieldset>
    ...
    <label for="estacionamiento">Estacionmiento:</label>
    <input type="number" id="estacionamiento" name="propiedad[estacionamiento]" placeholder="Cantidad de garage" min="1" max="9" value="<?php echo s($propiedad->estacionamiento); ?>">
</fieldset>
<fieldset>
